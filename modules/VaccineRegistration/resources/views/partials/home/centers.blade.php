...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <section class="trust-counter-section" id="trust-counter" data-aos="fade-up" data-aos-duration="700">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            <div class="trust-counter-card text-center p-6 md:p-8 bg-white rounded-2xl border border-slate-100/50 shadow-sm hover:shadow-md transition-all group">
            ...
            <div class="trust-counter-card text-center p-6 md:p-8 bg-white rounded-2xl border border-slate-100/50 shadow-sm hover:shadow-md transition-all group">
                ...
                @php($activeCentersCount = $activeCenters->count())
