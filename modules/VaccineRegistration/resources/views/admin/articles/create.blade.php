...
<div style="width: 100%; padding: 20px 0;">
    ...
    <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" style="background: #ffffff; padding: 32px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
        @csrf
        ...
        <div style="margin-bottom: 20px;">
            ...
            <div id="image_dropzone" class="image-upload-zone" style="padding: 20px;">
                ...
                <div id="image_preview_container" class="image-upload-preview-container">
                    <div class="image-upload-preview-wrapper">
                        <img id="image_preview" class="image-upload-preview" src="" alt="Preview" style="max-height: 120px;">
        ...
        <div style="margin-bottom: 24px;">
            ...
            <div id="blocks-container" style="display: flex; flex-direction: column; gap: 20px; margin-bottom: 24px;">
                <!-- Các khối (Khối văn bản / Khối hình ảnh) sẽ được thêm động vào đây -->
            </div>
...
<!-- Block Builder Engine with TinyMCE Integration -->
<script>
