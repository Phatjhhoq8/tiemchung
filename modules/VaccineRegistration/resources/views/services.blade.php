...
<div style="max-width: 1200px; margin: 40px auto; padding: 0 20px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 32px;">
        ...
        <div style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 16px; padding: 36px; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
                <div style="width: 56px; height: 56px; background-color: rgba(2, 132, 199, 0.08); color: #0284c7; border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-bottom: 24px;">
            ...
            <a href="{{ route('vaccine.index', ['age_group' => 'người lớn']) }}" class="btn-primary" style="text-align: center; justify-content: center; background-color: #0284c7;">Xem danh mục vắc xin người lớn</a>
        </div>

        <div style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 16px; padding: 36px; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
                <div style="width: 56px; height: 56px; background-color: rgba(234, 170, 0, 0.08); color: #eaaa00; border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-bottom: 24px;">
            ...
            <a href="{{ route('vaccine.index', ['type' => 'package']) }}" class="btn-primary" style="text-align: center; justify-content: center; background-color: #d97706;">Xem các gói vắc xin ưu đãi</a>
        </div>

        <div style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 16px; padding: 36px; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
                <div style="width: 56px; height: 56px; background-color: rgba(22, 163, 74, 0.08); color: #16a34a; border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-bottom: 24px;">
            ...
            <a href="{{ route('register.show') }}" class="btn-primary" style="text-align: center; justify-content: center; background-color: #16a34a;">Đặt lịch tư vấn miễn phí</a>
        </div>
    </div>
</div>
@endsection
