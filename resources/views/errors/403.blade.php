...
@section('title', 'Lỗi 403 - Truy cập bị từ chối')
...
<div class="container mx-auto" style="max-width: 1200px; padding: 80px 15px; text-align: center; min-height: 60vh; display: flex; flex-direction: column; justify-content: center; align-items: center;">
    <div style="font-size: 120px; font-weight: 900; color: #f59e0b; line-height: 1; text-shadow: 4px 4px 0px #fef3c7;">403</div>
    <h1 style="font-size: 32px; font-weight: 700; color: #334155; margin-top: 24px; margin-bottom: 16px;">Truy cập bị từ chối</h1>
    <p style="font-size: 16px; color: #64748b; max-width: 500px; margin: 0 auto 32px auto; line-height: 1.6;">
        Bạn không có quyền truy cập vào trang này. Nếu bạn cho rằng đây là sự nhầm lẫn, vui lòng liên hệ với quản trị viên.
    </p>
