...
<div class="container mx-auto" style="max-width: 1200px; padding: 80px 15px; text-align: center; min-height: 60vh; display: flex; flex-direction: column; justify-content: center; align-items: center;">
    <div style="font-size: 120px; font-weight: 900; color: #0f172a; line-height: 1; text-shadow: 4px 4px 0px #e2e8f0;">404</div>
    <h1 style="font-size: 32px; font-weight: 700; color: #334155; margin-top: 24px; margin-bottom: 16px;">Ôi! Không tìm thấy trang</h1>
    <p style="font-size: 16px; color: #64748b; max-width: 500px; margin: 0 auto 32px auto; line-height: 1.6;">
        Trang bạn đang tìm kiếm có thể đã bị xóa, thay đổi tên hoặc tạm thời không thể truy cập. Vui lòng kiểm tra lại đường dẫn.
    </p>
