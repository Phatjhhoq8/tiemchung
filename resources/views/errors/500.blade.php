...
@section('title', 'Lỗi 500 - Lỗi máy chủ')
...
<div class="container mx-auto" style="max-width: 1200px; padding: 80px 15px; text-align: center; min-height: 60vh; display: flex; flex-direction: column; justify-content: center; align-items: center;">
    <div style="font-size: 120px; font-weight: 900; color: #ef4444; line-height: 1; text-shadow: 4px 4px 0px #fee2e2;">500</div>
    <h1 style="font-size: 32px; font-weight: 700; color: #334155; margin-top: 24px; margin-bottom: 16px;">Lỗi hệ thống</h1>
    <p style="font-size: 16px; color: #64748b; max-width: 500px; margin: 0 auto 32px auto; line-height: 1.6;">
        Đã xảy ra lỗi không mong muốn trên máy chủ của chúng tôi. Xin lỗi vì sự bất tiện này. Chúng tôi đang nỗ lực khắc phục sự cố sớm nhất có thể.
    </p>
