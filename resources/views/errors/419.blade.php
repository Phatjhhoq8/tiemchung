...
@section('title', 'Lỗi 419 - Phiên bản hết hạn')
...
<div class="container mx-auto" style="max-width: 1200px; padding: 80px 15px; text-align: center; min-height: 60vh; display: flex; flex-direction: column; justify-content: center; align-items: center;">
    <div style="font-size: 120px; font-weight: 900; color: #64748b; line-height: 1; text-shadow: 4px 4px 0px #f1f5f9;">419</div>
    <h1 style="font-size: 32px; font-weight: 700; color: #334155; margin-top: 24px; margin-bottom: 16px;">Phiên bản hết hạn</h1>
    <p style="font-size: 16px; color: #64748b; max-width: 500px; margin: 0 auto 32px auto; line-height: 1.6;">
        Phiên làm việc của bạn đã hết hạn do không có thao tác nào trong một khoảng thời gian. Vui lòng tải lại trang hoặc đăng nhập lại.
    </p>
